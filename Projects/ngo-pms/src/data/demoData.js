...
// Task Heads/Tags for organizing tasks within projects
export const demoTaskHeads = [
  // Clean Water Initiative Task Heads
  {
    id: 'head-1',
    projectId: 'project-1',
    name: 'Survey & Assessment',
    color: '#3B82F6', // blue
    description: 'Initial surveys, assessments, and research activities',
    order: 1,
    createdAt: '2025-01-15T00:00:00.000Z'
  },
  {
    ...
    name: 'Procurement',
    color: '#10B981', // green
    description: 'Equipment and materials procurement activities',
    order: 2,
    createdAt: '2025-01-15T00:00:00.000Z'
  },
  {
    ...
    name: 'Installation',
    color: '#F59E0B', // amber
    description: 'Installation and construction activities',
    order: 3,
    createdAt: '2025-01-15T00:00:00.000Z'
  },
  {
    ...
    color: '#8B5CF6', // purple
    description: 'Community training and quality testing activities',
    order: 4,
    createdAt: '2025-01-15T00:00:00.000Z'
  },
  // Community Schooling Program Task Heads
  {
    id: 'head-5',
    projectId: 'project-2',
    name: 'Staff Recruitment',
    color: '#3B82F6',
    description: 'Teacher and staff recruitment activities',
    order: 1,
  ...
  },
  {
    ...
    color: '#10B981',
    description: 'Curriculum development and planning activities',
    order: 2,
    createdAt: '2025-03-01T00:00:00.000Z'
  },
  {
    ...
    name: 'Construction',
    color: '#F59E0B',
    description: 'School building construction activities',
    order: 3,
    createdAt: '2025-03-01T00:00:00.000Z'
  },
  {
    id: 'head-8',
    projectId: 'project-2',
    name: 'Enrollment & Distribution',
    color: '#8B5CF6',
    description: 'Student enrollment and material distribution',
    order: 4,
    createdAt: '2025-03-01T00:00:00.000Z'
  },
  // Healthcare Awareness Campaign Task Heads
  {
    id: 'head-9',
    projectId: 'project-3',
    name: 'Planning & Coordination',
    color: '#3B82F6',
    description: 'Campaign planning and partner coordination',
    order: 1,
  ...
  },
  {
    id: 'head-10',
    projectId: 'project-3',
    name: 'Materials & Training',
    color: '#10B981',
    description: 'Material design and team training',
    order: 2,
    createdAt: '2026-01-15T00:00:00.000Z'
  },
  // Emergency Relief Response Task Heads
  {
    id: 'head-11',
    projectId: 'project-4',
    name: 'Assessment & Procurement',
    color: '#EF4444', // red for emergency
    description: 'Needs assessment and supply procurement',
    order: 1,
  ...
  },
  {
    ...
    name: 'Distribution',
    color: '#F59E0B',
    description: 'Emergency supply distribution activities',
    order: 2,
    createdAt: '2025-11-01T00:00:00.000Z'
  }
];
...
export const demoTasks = [
  // Clean Water Initiative Tasks
  {
    id: 'task-1',
    projectId: 'project-1',
    taskHeadId: 'head-1', // Survey & Assessment
  ...
  },
  {
    id: 'task-3',
    projectId: 'project-1',
    taskHeadId: 'head-3', // Installation
  ...
  },
  {
    id: 'task-4',
    projectId: 'project-1',
    taskHeadId: 'head-4', // Training & Testing
  ...
  // Community Schooling Program Tasks
  {
    id: 'task-6',
    projectId: 'project-2',
    taskHeadId: 'head-5', // Staff Recruitment
  ...
  },
  {
    id: 'task-7',
    projectId: 'project-2',
    taskHeadId: 'head-6', // Curriculum & Planning
  ...
  },
  {
    id: 'task-8',
    projectId: 'project-2',
    taskHeadId: 'head-7', // Construction
  ...
  },
  {
    id: 'task-9',
    projectId: 'project-2',
    taskHeadId: 'head-8', // Enrollment & Distribution
  ...
  // Healthcare Awareness Campaign Tasks
  {
    id: 'task-11',
    projectId: 'project-3',
    taskHeadId: 'head-9', // Planning & Coordination
  ...
  },
  {
    id: 'task-12',
    projectId: 'project-3',
    taskHeadId: 'head-10', // Materials & Training
  ...
  // Emergency Relief Response Tasks
  {
    id: 'task-15',
    projectId: 'project-4',
    taskHeadId: 'head-11', // Assessment & Procurement
  ...
  },
  {
    id: 'task-17',
    projectId: 'project-4',
    taskHeadId: 'head-12', // Distribution
